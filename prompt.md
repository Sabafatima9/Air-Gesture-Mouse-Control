...
- **Closed fist = clutch** (all four fingers curled AND thumb tucked). No motion, no clicks; re-anchor every fist frame so reopening anywhere never jumps the cursor.
